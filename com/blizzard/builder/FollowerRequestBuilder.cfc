<cfcomponent output="false" extends="com.blizzard.builder.AbstractRequestBuilder">
	...
	<cffunction name="constructRequestObject" returntype="com.blizzard.request.AbstractRequest" access="public" output="false">
		...
		<cfset var reqObj	= CreateObject( 'component', 'com.blizzard.request.FollowerRequest' ).init( getPublicKey(), getPrivateKey(), getCache() ) />
		<cfset reqObj		= CreateObject( 'component', 'com.blizzard.decorator.LocaleSpecifier' ).init( reqObj ) />
				
		<cfset ri 			= reqObj.getResourceIdentifier() & '/' & arguments.followerId />
